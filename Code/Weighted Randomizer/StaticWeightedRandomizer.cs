...
namespace Weighted_Randomizer
{
    ...
    public class StaticWeightedRandomizer<TKey> : IWeightedRandomizer<TKey>
    {
        ...
        /// <summary>
        /// Step three:  All the remaining items in smallList necessarily have probability of 100%
        /// </summary>
        ...
        #endregion IWeightedRandomizer<T> stuff
    }
}