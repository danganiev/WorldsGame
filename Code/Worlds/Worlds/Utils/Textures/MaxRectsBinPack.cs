...
public class MaxRectsBinPack
{
    ...
    public void Init(int width, int height, bool rotations = true)
    {
        ...
        var rectangle = new Rectangle { X = 0, Y = 0, Width = width, Height = height };
    ...
    private Rectangle ScoreRect(int width, int height, FreeRectChoiceHeuristic method, ref int score1, ref int score2)
    {
        var newNode = new Rectangle();
        score1 = int.MaxValue;
        score2 = int.MaxValue;
    ...
    private Rectangle FindPositionForNewNodeBestShortSideFit(int width, int height, ref int bestShortSideFit, ref int bestLongSideFit)
    {
        var bestNode = new Rectangle();
        //memset(&bestNode, 0, sizeof(Rect));
    ...
    private Rectangle FindPositionForNewNodeBestLongSideFit(int width, int height, ref int bestShortSideFit, ref int bestLongSideFit)
    {
        var bestNode = new Rectangle();
        //memset(&bestNode, 0, sizeof(Rect));
