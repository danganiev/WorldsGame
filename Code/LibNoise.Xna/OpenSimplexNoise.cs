...
{
    // Ported from java
    // http://stackoverflow.com/questions/15463033/c-sharp-randomlong
    ...
    public class OpenSimplexNoise
    {
        ...
        private readonly short[] permGradIndex3D;
        ...
        public OpenSimplexNoise(long seed)
        {
            ...
            for (short i = 0; i < 256; i++)
                source[i] = i;
            var random = new LongRandom(seed);
            for (int i = 255; i >= 0; i--)
            {
        ...
        {
            // NOTE: This is probably wrong, but I have no choice
            return Noise(x, y, 0);
        }
        ...
        private static readonly short[] gradients3D = new short[] {
        ...
        public static readonly short[] PERM_DEFAULT = new short[] {
