...
namespace Nuclex.UserInterface.Visuals.Flat.Renderers {
  ...
  /// <summary>Renders panel controls in a traditional flat style</summary>
  public class FlatBorderlessPanelControlRenderer :
    IFlatControlRenderer<Controls.Arcade.BorderlessPanelControl>
  {
      ...
      /// </param>
      public void Render(
        BorderlessPanelControl control, IFlatGuiGraphics graphics
      )
      {

          // This is simple! A panel consists of a single element we need to draw.
          graphics.DrawElement("borderless_window", control.GetAbsoluteBounds());
